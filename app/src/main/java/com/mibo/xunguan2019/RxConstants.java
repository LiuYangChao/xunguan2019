...
public class RxConstants {
    ...
    //----------------------------------------------------本地项目常量- start ------------------------------------------------------------
    public static final String NODE_NORMAL = "NODE_NORMAL";                 //普通节点
    public static final String NODE_END = "NODE_END";                                 //叶子节点
    ...
    //本地App包名
    public static final String LOCAL_PACKAGE_NAME = "com.mibo.xunguan";
    ...
    //默认保存下载文件目录
    public static final String DOWNLOAD_DIR = RxFileTool.getRootPath() + File.separator + "Download" + File.separator + LOCAL_PACKAGE_NAME + File.separator;
...
//    public static final String PICTURE_CACHE_PATH = RxFileTool.getCacheFolder(RxTool.getContext()) + File.separator + "Picture" + File.separator + "Cache" + File.separator;
    ...
    //图片原始路径
    public static final String PICTURE_ORIGIN_PATH = RxFileTool.getRootPath() + File.separator + LOCAL_PACKAGE_NAME + File.separator + "Picture" + File.separator+ "Origin" + File.separator;

    //图片压缩路径
    public static final String PICTURE_COMPRESS_PATH = RxFileTool.getRootPath() + File.separator + LOCAL_PACKAGE_NAME + File.separator + "Picture" + File.separator+ "Compress" + File.separator;

    //默认导出文件目录
    public static final String EXPORT_FILE_PATH = RxFileTool.getRootPath() + File.separator + LOCAL_PACKAGE_NAME + File.separator + "ExportFile" + File.separator;
